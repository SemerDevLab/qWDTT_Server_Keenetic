...
Готовые IPK-пакеты для всех поддерживаемых архитектур находятся в разделе [Releases] Выберите нужную версию и скачайте пакет согласно архитектуре роутера:
...
1. Откройте нужный релиз в разделе [Releases] и скачайте пакет, соответствующий архитектуре роутера.
...
Скачайте новую версию из раздела [Releases] и установите её поверх текущей:
